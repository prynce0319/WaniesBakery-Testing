                                ...
                                @foreach ($pattributes as $pattribute )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="confirm(' Do you really want to delete this attribute?') || event.stopImmediatePropagation()" wire:click.prevent="deleteAttribute({{ $pattribute->id }})"  style="margin-left:10px;"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>                                  
                                @endforeach
                            </tbody>
