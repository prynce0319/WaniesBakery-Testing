							...
							<div class="contact-box contact-info">
								<div class="wrap-map">
									...
									{{-- <div class="mercado-google-maps"
										 ...
										 data-title_maps="Wanies Bakery"
										 data-phone="0594-867-002"
										 data-email="hertyj2016@gmail.com"
										 data-address="Wanies Bakery. Owusu Afriyie Street"
										 data-longitude="-1.578772"
										 data-latitude="6.734061"
										 data-pin-icon=""
										 data-zoom="16"
								...
								<div class="wrap-icon-box">
									...
									<div class="icon-box-item">
										...
										<div class="right-info">
											<b>Location</b>
											<p>{{ $setting->name ?? 'null' }}</br />{{ $setting->address ?? 'null' }}</p>
										</div>
									</div>
