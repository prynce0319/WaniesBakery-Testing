...
use App\Http\Livewire\CustomOrderComponent;
...
Route::get('/checkout/form', PaymentComponent::class)->name('checkout.form');
...
Route::get('/custom-order',CustomOrderComponent::class)->name('custom.order');

Route::post('/checkout/form/pay', [App\Http\Controllers\PaymentController::class, 'redirectToGateway'])->name('pay');
...
Route::middleware(['auth:sanctum','verified','authadmin'])->group(function (){
    ...
    Route::get('/admin/orders/{order_id}/message',AdminCustomersComponent::class)->name('admin.customermessage');
